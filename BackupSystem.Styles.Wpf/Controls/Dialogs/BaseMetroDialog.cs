...
namespace BackupSystem.Styles.Wpf.Controls.Dialogs
{
    ...
    public abstract class BaseMetroDialog : ContentControl
    {
        ...
        /// <summary>
        /// Initializes a new BackupSystem.Styles.Wpf.Controls.BaseMetroDialog.
        /// </summary>
        ...
        private void Initialize()
        {
            ...
            this.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/BackupSystem.Styles.Wpf;component/Themes/Dialogs/BaseMetroDialog.xaml") });
